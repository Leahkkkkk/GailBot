...
def initialize_configured_service() -> OrganizerService:
    ...
    return OrganizerService(fs_service)
...
def test_organizer_service_add_source_valid() -> None:
    ...
    assert service.add_source("file",WAV_FILE_PATH,RESULT_DIR_PATH,"GB")
    assert service.add_source("dir",CONV_DIR_PATH,RESULT_DIR_PATH,"GB")
