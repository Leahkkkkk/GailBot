...
# # @Last Modified time: 2023-02-07 17:58:22
...
#     timestamp_texts = []
#     for segment in transcribe_res['segments']:
#         word_list = segment["words"]
#         for item in word_list:
#             start = item['start']
#             end = item['end']
...
# # def get_text_with_timestamp(transcribe_res):
# #     timestamp_texts = []
# #     for item in transcribe_res['segments']["words"]:
# #         start = item['start']
# #         end = item['end']
# #         text = item['text']
# #         timestamp_texts.append((Segment(start, end), text))
...
#     print("timestamp texts", timestamp_texts)
#     spk_text = add_speaker_info_to_text(timestamp_texts, diarization_result)
#     print("spk_test", spk_text)
