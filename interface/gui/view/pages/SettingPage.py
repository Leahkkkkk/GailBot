...
from view.widgets import Button, SpacerLine
...
class SettingPage(QWidget):
    ...
    def _initWidget(self):
        ...
        self.requiredSetBtn = Button.ColoredBtn("Required Settings", Color.WHITE, Color.BLACK)
        self.postSetBtn = Button.ColoredBtn("Post Transcription Settings", Color.WHITE, Color.BLACK)
        #self.verticalLine = SpacerLine.QVSeperationLine()
    ...
    def _initLayout(self):
        ...
        #self.layout.addWidget(self.verticalLine, 0, 1)
        self.layout.addWidget(self.requiredSetBtn, 1, 0)
        self.layout.addWidget(self.postSetBtn, 2, 0)
        self.layout.addWidget(self.saveBtn,5,0, alignment = Qt.AlignmentFlag.AlignHCenter)
        self.layout.addWidget(self.cancelBtn, 6, 0, alignment = Qt.AlignmentFlag.AlignHCenter)
    ...
    def _connectSignal(self):
        ...
        self.postSetBtn.clicked.connect(lambda: self.postSetBtn.changeColor(Color.GREYLIGHT))
        self.postSetBtn.clicked.connect(lambda: self.requiredSetBtn.changeColor("#FFFFFF"))
        self.requiredSetBtn.clicked.connect(lambda: self.settingStack.
                                            setCurrentWidget(self.RequiredSetPage))
        self.requiredSetBtn.clicked.connect(lambda: self.requiredSetBtn.changeColor(Color.GREYLIGHT))
        self.requiredSetBtn.clicked.connect(lambda: self.postSetBtn.changeColor("#FFFFFF"))
    ...
    def _initStyle(self):
        ...
        self.requiredSetBtn.setFixedSize(QtCore.QSize(270,35))
        self.postSetBtn.setFixedSize(QtCore.QSize(270,35))
        self.cancelBtn.setMinimumSize(QtCore.QSize(150,30))
        self.saveBtn.setMinimumSize(QtCore.QSize(150,30))
        self.postSetBtn.changeTextColor(Color.BLACK)
        self.requiredSetBtn.changeTextColor(Color.BLACK)
